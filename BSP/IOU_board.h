...
////////////////////////////////////////
	...
	#define TEC_FAULT0_TEC0_PORT	PORTG
	#define TEC_FAULT0_TEC0_DDR		DDRG
	#define TEC_FAULT0_TEC0_PIN		PING4
	
	#define TEC_FAULT1_TEC0_PORT	PORTG
	#define TEC_FAULT1_TEC0_DDR		DDRG
	#define TEC_FAULT1_TEC0_PIN		PING3
	
	#define TEC_SHUTDOWN_TEC1_PORT	PORTA
	#define TEC_SHUTDOWN_TEC1_DDR	DDRA
	#define TEC_SHUTDOWN_TEC1_PIN	PINA7

	#define TEC_FAULT0_TEC1_PORT	PORTA
	#define TEC_FAULT0_TEC1_DDR		DDRA
	#define TEC_FAULT0_TEC1_PIN		PINA5
	
	#define TEC_FAULT1_TEC1_PORT	PORTA
	#define TEC_FAULT1_TEC1_DDR		DDRA
	#define TEC_FAULT1_TEC1_PIN		PINA6

	#define TEC_SHUTDOWN_TEC2_PORT	PORTA
	#define TEC_SHUTDOWN_TEC2_DDR	DDRA
	#define TEC_SHUTDOWN_TEC2_PIN	PINA4
	
	#define TEC_FAULT0_TEC2_PORT	PORTA
	#define TEC_FAULT0_TEC2_DDR		DDRA
	#define TEC_FAULT0_TEC2_PIN		PINA2
	
	#define TEC_FAULT1_TEC2_PORT	PORTA
	#define TEC_FAULT1_TEC2_DDR		DDRA
	#define TEC_FAULT1_TEC2_PIN		PINA3

	#define TEC_SHUTDOWN_TEC3_PORT	PORTC
	#define TEC_SHUTDOWN_TEC3_DDR	DDRC
	#define TEC_SHUTDOWN_TEC3_PIN	PINC6
	
	#define TEC_FAULT0_TEC3_PORT	PORTC
	#define TEC_FAULT0_TEC3_DDR		DDRC
	#define TEC_FAULT0_TEC3_PIN		PINC2
	
	#define TEC_FAULT1_TEC3_PORT	PORTC
	#define TEC_FAULT1_TEC3_DDR		DDRC
	#define TEC_FAULT1_TEC3_PIN		PINC3
////////////////////////////////////////
...
/*==========================================================================================*/
	...
	#define TEC_FAULT0_TEC0_PORT	PORTG
	#define TEC_FAULT0_TEC0_DDR		DDRG
	#define TEC_FAULT0_TEC0_PIN		PING3
	
	#define TEC_FAULT1_TEC0_PORT	PORTD
	#define TEC_FAULT1_TEC0_DDR		DDRD
	#define TEC_FAULT1_TEC0_PIN		PIND5
	...
	#define TEC_FAULT0_TEC1_PORT	PORTA
	#define TEC_FAULT0_TEC1_DDR		DDRA
	#define TEC_FAULT0_TEC1_PIN		PINA6
	
	#define TEC_FAULT1_TEC1_PORT	PORTA
	#define TEC_FAULT1_TEC1_DDR		DDRA
	#define TEC_FAULT1_TEC1_PIN		PINA5
	...
	#define TEC_FAULT0_TEC2_PORT	PORTA
	#define TEC_FAULT0_TEC2_DDR		DDRA
	#define TEC_FAULT0_TEC2_PIN		PINA3
	
	#define TEC_FAULT1_TEC2_PORT	PORTA
	#define TEC_FAULT1_TEC2_DDR		DDRA
	#define TEC_FAULT1_TEC2_PIN		PINA2
	
	#define TEC_SHUTDOWN_TEC3_PORT	PORTB
	#define TEC_SHUTDOWN_TEC3_DDR	DDRB
	#define TEC_SHUTDOWN_TEC3_PIN	PINB0

	#define TEC_FAULT0_TEC3_PORT	PORTE
	#define TEC_FAULT0_TEC3_DDR		DDRE
	#define TEC_FAULT0_TEC3_PIN		PINE7
	
	#define TEC_FAULT1_TEC3_PORT	PORTE
	#define TEC_FAULT1_TEC3_DDR		DDRE
	#define TEC_FAULT1_TEC3_PIN		PINE6
